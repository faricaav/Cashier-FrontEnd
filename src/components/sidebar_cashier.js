                ...
                <ul className="pt-6">
                    ...
                    <li className="flex  rounded-md p-2 cursor-pointer text-white text-sm items-center gap-x-4">
                        <div className={`${!open && "mx-n3 mt-3"} text-xl`} ><SiAirtable /></div>
                            <Link to="/chooseTable" className="nav-link"><span className={`${!open && "hidden gap-x-4"} origin-left duration-200 text-white`}>
                                Table
                            </span>
                            </Link>
                    </li>
                    <li className="flex  rounded-md p-2 cursor-pointer text-white text-sm items-center gap-x-4">
                        <div className={`${!open && "mx-n3 mt-3"} text-xl`} ><MdRestaurantMenu /></div>
                            <Link to="/chooseMenu" className="nav-link"><span className={`${!open && "hidden gap-x-4"} origin-left duration-200 text-white`}>
                                Menu
                            </span>
                            </Link>
                    </li>
                    <li className="flex  rounded-md p-2 cursor-pointer text-white text-sm items-center gap-x-4">
                        <div className={`${!open && "mx-n3 mt-3"} text-xl`} ><FaCashRegister /></div>
                            <Link to="/transaction_cashier" className="nav-link"><span className={`${!open && "hidden gap-x-4"} origin-left duration-200 text-white`}>
                                Transaction
                            </span>
                            </Link>
                    </li>
